...
npx hardhat run scripts/deploy_00_real_oracles.js
npx hardhat run scripts/deploy_00_testnet_lptoken.js
npx hardhat run scripts/deploy_01_deploy_contracts.js
npx hardhat run scripts/deploy_02_deploy_geyser.js
